...
$(function() {
	$("input.file_1").filestyle({ 
		image: "/www/admin/images/forms/upload_file.gif",
		imageheight : 29,
		imagewidth : 78,
		width : 300
	});
	...
	<td>
		...
		<td class="noheight">
			...
			<tr  valign="top">
				...
				<td><a href=""  id="date-pick"><img src="/www/admin/images/forms/icon_calendar.jpg"   alt="" /></a></td>
			</tr>
			</table>
		</td>
		<td></td>
...
<tr>
<td><img src="/www/admin/images/shared/blank.gif" width="695" height="1" alt="blank" /></td>
<td></td>
</tr>
</table>
