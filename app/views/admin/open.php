		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<td class="yellow-right"><a class="close-yellow"><img src="/www/admin/images/table/icon_close_yellow.gif"   alt="" /></a></td>
				</tr>
				</table>
				</div>
				<!--  end message-yellow -->
				...
				<tr>
					...
					<td class="red-right"><a class="close-red"><img src="/www/admin/images/table/icon_close_red.gif"   alt="" /></a></td>
				</tr>
				</table>
				</div>
				<!--  end message-red -->
				...
				<tr>
					...
					<td class="blue-right"><a class="close-blue"><img src="/www/admin/images/table/icon_close_blue.gif"   alt="" /></a></td>
				</tr>
				</table>
				</div>
				<!--  end message-blue -->
				...
				<tr>
					...
					<td class="green-right"><a class="close-green"><img src="/www/admin/images/table/icon_close_green.gif"   alt="" /></a></td>
				</tr>
				</table>
				</div>
				<!--  end message-green -->
