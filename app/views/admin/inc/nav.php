		...
		<div id="nav-right">
			...
			<div class="showhide-account"><img src="/www/admin/images/shared/nav/nav_myaccount.gif" width="93" height="14" alt="" /></div>
			<div class="nav-divider">&nbsp;</div>
			<a href="/index.php/manage/logout" id="logout"><img src="/www/admin/images/shared/nav/nav_logout.gif" width="64" height="14" alt="" /></a>
			<div class="clear">&nbsp;</div>
